    ...
    <div className='mt-12 px-[59px] flex flex-col gap-5 '>
      <div className='flex items-center justify-between'>
          ...
          <button
            ...
            className= {`py-1 px-4 rounded-l-full  rounded-r-full border border-gray-400 ${isActived === 0  && "bg-[#0e8080] text-white"}`}
            >
            VIỆT NAM
          </button>
          <button
            ...
            className= {`py-1 px-4 rounded-l-full  rounded-r-full border border-gray-400  ${isActived === 1 && "bg-[#0e8080] text-white"}`}
            >
              QUỐC TẾ
            </button>
          </div>
